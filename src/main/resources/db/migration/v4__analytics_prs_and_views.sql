...
--PRs per exercise both top single, best 1RM (estimate)
...
create or replace view v_weekly_volume as--weekly volume
select
  user_id,
...
group by sess.id, sess.user_id, sess.started_at;--summaries of recent session
